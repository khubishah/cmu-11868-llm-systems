...
#SBATCH --output=output_fused_%j.log      # Standard output file (%j will be replaced with job ID)
#SBATCH --error=error_fused_%j.log        # Standard error file (%j will be replaced with job ID)
...
# execute training with FUSED kernels
echo "=================================="
...
echo "=================================="
python project/run_machine_translation.py --use_fused_kernel=True --n_epochs=1 --batch_size=64 --samples_per_epoch=5000 --learning_rate=0.005 --max_grad_norm=1.0
echo "=================================="
